...
{
  const char *twoSurnames[40] = {"軒轅", "歐陽", "司馬", "司徒", "司空", "司寇", "上官", "尉遲", "羊舌", "第五", "梁丘", "鍾離", "東郭", "公孫", "孟孫", "仲孫", "叔孫", "季孫", "長孫", "慕容", "宇文", "閭丘", "諸葛", "東方", "西門", "公羊", "夏侯", "萬俟", "百里", "端木", "公冶", "皇甫", "呼延", "浮屠", "令狐", "淳於", "即墨", "單于", "南宮", "毌丘"};
  const char *oneNames[40] = {"轅", "陽", "馬", "徒", "空", "寇", "官", "遲", "舌", "五", "丘", "離", "郭", "孫", "孫", "孫", "孫", "孫", "孫", "容", "文", "丘", "葛", "方", "門", "羊", "侯", "俟", "裡", "木", "冶", "甫", "延", "屠", "狐", "於", "墨", "於", "宮", "丘"};
